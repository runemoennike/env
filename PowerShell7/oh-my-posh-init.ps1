...
$global:_ompExecutable = 'C:/Users/rajm/AppData/Local/Programs/oh-my-posh/bin/oh-my-posh.exe'
...
New-Module -Name "oh-my-posh-core" -ScriptBlock {
    ...
    $env:POSH_SESSION_ID = 'cf66e774-667d-4666-9ebe-4f5ca5dfe51b'
    $env:CONDA_PROMPT_MODIFIER = $false

    # set the default theme
    if ('c:\rune\env\oh-my-posh\rune.minimal.omp.yaml' -and (Test-Path -LiteralPath 'c:\rune\env\oh-my-posh\rune.minimal.omp.yaml')) {
        $env:POSH_THEME = (Resolve-Path -Path 'c:\rune\env\oh-my-posh\rune.minimal.omp.yaml').ProviderPath
    }
